...
apt install -y  apache2 apr apr-util autoconf bison busybox clang coreutils git ruby ruby-dev nmap netcat openssh make php-pgsql figlet ecj
...
apt install -y  python2  python2-dev php inetutils findutils readline-dev  openssl tcpdump unzip openssl-dev termux-tools termux-api zip w3m 
